...
class JWTokens(object):
    """ This class will define the setup details which will be useful in token generation """
    def generate_token(self, user_detail):
        """ 
        This method generates the token. Components of a JWT include
        1. A header-simply a JSON string but it contains information about the algorithm of JWT encryption
